...
//		// 2*(5-3) = 4
//		BE e=new BE('*',new Num(2.0),new BE('3..0-',new Num(5.0),new Num(3.0)));
...
//		int x=r.nextInt(4);
//		switch(x) {
//		case 0:return new BE('+',buildRand(),buildRand());
//		case 1:return new BE('-',buildRand(),buildRand());
//		case 2:return new BE('*',buildRand(),buildRand());
//		case 3:return new BE('/',buildRand(),buildRand());
//		}
//		return null;
//	}
//
...
//			BE be=(BE)(e);
//			switch(be.operator) {
//			case '+':return calculate(be.left,false)+calculate(be.right,true);
//			case '-':return calculate(be.left,false)-calculate(be.right,true);
//			case '*':return calculate(be.left,false)*calculate(be.right,true);
//			case '/':return calculate(be.left,false)/calculate(be.right,true);
//			}
